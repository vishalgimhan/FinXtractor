...
from .nodes import extractor_node, validator_node, retry_node, hitl_node, scoring_node
...
def build_pipeline() -> StateGraph:
    ...
    g.add_edge(START, "extractor")          # entry
    ...
    g.add_edge("retry", "extractor")        # the retry loop, as an edge
